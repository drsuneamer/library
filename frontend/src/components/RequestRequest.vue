<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            Request # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            Request
        </v-card-title >        
        ...
        <v-card-text>
            ...
            <Number label="RequestId" v-model="value.requestId" :editMode="editMode" :inputUI="''"/>
