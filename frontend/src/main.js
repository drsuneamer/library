...
pluralCaseList.push( {plural: "donates/donates", pascal: "DonateDonate"} )

pluralCaseList.push( {plural: "requests/requests", pascal: "RequestRequest"} )


pluralCaseList.push( {plural: "books/books", pascal: "BooksBooks"} )
